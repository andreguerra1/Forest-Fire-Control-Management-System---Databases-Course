    ...
    <body>
        ...
        <?php
            try {
                ...
                $sql = "SELECT n_meio, nome_entidade FROM meio EXCEPT(SELECT n_meio, nome_entidade FROM meio_combate);";
                ...
                echo("<br><form style='position:absolute; left:330px;' action='insertMeioCombate.php' id='insertform'>");
                ...
                foreach ($result as $row){
                    ...
                    $n_meio = $row['n_meio'];
                    $nome_entidade = $row['nome_entidade'];
                    echo("<td><button type='button' onclick=\"window.location.href='removeMeioCombate.php?n_meio=$n_meio&nome_entidade=$nome_entidade'\"> Remover </button>");           
                    echo("</td></tr>\n");
